...
public class  OnTheWayActivity extends AppCompatActivity implements OnMapReadyCallback,
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btn_start_payments.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent navi=new Intent(OnTheWayActivity.this,ReachDestinationActivity.class);
                startActivity(navi);
            }
        });
